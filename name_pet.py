...
def choose_item(question, list):
    ...
    print("you chose: {}".format(list[choice][0]))
...
def name_pet(path_dictionary, path_list, names_dictionary, names_list):
    ...
    # if the user the chooses the path of picking a name from a list
        ...
        choose_item("Which name would you like to pick?", names_list)
...
NAMES_DICTIONARY = {"Leaf": 1, "Noodles": 2, "Nofeet": 3, "Pretzel": 4, "Slip": 5, "Slinky": 6, "Slithers": 7, "Sunshine": 8, "Worm": 9, "Zippy": 10, "Fluffy": 11, "Monty the Python": 12, "William Snakespeare": 13}

NAMES_LIST = [["Leaf", 1], ["Noodles", 2], ["Nofeet", 3], ["Pretzel", 4], ["Slip", 5], ["Slinky", 6], ["Slithers", 7], ["Sunshine", 8], ["Worm", 9], ["Zippy", 10], ["Fluffy", 11], ["Monty the Python", 12], ["William Snakespeare", 13]]

# calling the function for testing
name_pet(PATH_DICTIONARY, PATH_LIST, NAMES_DICTIONARY, NAMES_LIST)
