...
def check_if_dead(weight, min_weight, max_weight):
    ...
    if weight > max_weight:
        ...
        # if the pet_weight doesn't reach the minimum weight, the death_screen function runs.
        death_screen(weight, death_type)
...
while alive == True:
    ...
    if path == 0:
        ...
        death = check_if_dead(pet_weight, min_weight, max_weight)
        # for testing
        print(death)
